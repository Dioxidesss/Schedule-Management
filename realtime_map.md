> Platform note: channels/events are implemented via Supabase Realtime. Render workers publish server-side events; Vercel clients subscribe from manager/admin UIs.
