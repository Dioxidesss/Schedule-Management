    ...
    return (
        <div className="bg-background-dark font-display min-h-screen flex flex-col items-center justify-center text-slate-100 overflow-hidden relative">
            ...
            <div className="w-full max-w-md h-screen max-h-[900px] flex flex-col bg-background-dark border-x border-white/10 shadow-2xl relative">
                {/* Header */}
                <header className="flex items-center justify-between px-6 py-5 border-b border-white/10 bg-[#0d1633]">
                ...
                {/* Timer */}
                <main className="flex-1 flex flex-col px-6 py-8 gap-8 justify-center items-center relative">
                    <div className="flex flex-col items-center justify-center w-full py-6 flex-1">
                        <div className="flex flex-col items-center justify-center">
                            <div
                                className="font-mono font-bold text-7xl sm:text-8xl text-neon-cyan tracking-tighter tabular-nums drop-shadow-[0_0_15px_rgba(13,242,242,0.3)]"
                                aria-live="polite"
                            ...
                            <div className="mt-8 flex items-center gap-2 px-5 py-3 rounded-full bg-white/5 border border-white/5">
                                ...
                                <p className="text-slate-300 text-sm font-medium tracking-wide uppercase">
                                    Target: <span className="text-white font-bold">60 Mins</span>
                                </p>
                            </div>
                            <div className="w-full h-1.5 bg-white/10 rounded-full mt-12 overflow-hidden max-w-xs" role="progressbar" aria-valuenow={0} aria-valuemin={0} aria-valuemax={60} aria-label="Unloading progress">
                                <div className="h-full bg-neon-cyan w-0 animate-pulse" />
                            </div>
                        </div>
                    </div>
                </main>
                ...
                {/* Action buttons */}
                <footer className="p-6 pt-2 bg-background-dark">
                    <div className="grid grid-cols-2 gap-4 h-20">
                        <button
                            type="button"
                            className="relative overflow-hidden rounded-xl bg-neon-green hover:bg-[#4aff25] text-background-dark font-bold text-lg flex flex-col items-center justify-center shadow-glow-green active:scale-[0.98] transition-all"
                        >
                        ...
                        <button
                            type="button"
                            className="relative overflow-hidden rounded-xl bg-royal-blue hover:bg-[#527af2] text-white font-bold text-lg flex flex-col items-center justify-center shadow-lg shadow-blue-500/10 active:scale-[0.98] transition-all"
                        >
