> Platform note: Supabase Auth is the system of record for sessions/JWT. `/auth/*` endpoints are optional backend wrappers; frontend may call Supabase directly.

POST /auth/signup (optional wrapper over Supabase Auth)
  - Auth: none
