Phase 1: Auth & tenancy scaffolding
- Implement email login/signup + Google OAuth callback
- Build /me profile read/update + password change
- Wire users/company/facility role scoping middleware
...
Phase 8: Overrun detection engine
- Add cron worker (60s) for derived overrun checks
- Push overrun alerts and highlight affected appointments
